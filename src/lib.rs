...
#[derive(Debug)]
pub struct OathBeaconProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OathBeaconProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OathBeacon processing");
    
    let mut processor = OathBeaconProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OathBeaconProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OathBeaconProcessor::new(false);
